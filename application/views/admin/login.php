...
<head>
    ...
    <meta name="description" content="لوحة التحكم - وكالة كنعان" />
...
<!--                        <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span> الدخـول إلى لوحة التحكم </span></h6>-->
                    ...
                    <div class="card-body collapse in">
                        <div class="card-block">
                            <form class="form-horizontal" action="<?php echo base_url().'admin/loginpost'?>" novalidate="" method="post" />
                            <fieldset class="form-group has-feedback has-icon-left">
                                <input type="email" name="username" class="form-control input-lg" id="user-name" placeholder="اسم المستخدم" tabindex="1" required="" data-validation-required-message="أدخـل اسم المستخدم" />
                            ...
                            <fieldset class="form-group has-feedback has-icon-left">
                                <input type="password" name="password" class="form-control input-lg" id="password" placeholder="كلمة المرور" tabindex="2" required="" data-validation-required-message="أدخـل كلمة المـرور" />
                                <div class="form-control-position">
                                    <i class="icon-key3"></i>
                                </div>
                                <div class="help-block font-small-3"></div>
