                      ...
                      <div class="form-body">
                        ...
                        <div class="row">
                          ...
                          <input type="text" id="issueinput3" class="form-control" name="comments" placeholder="مقتطف" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="مقتطف"/>
                                <textarea  style="display:none;" id="issueinput333" rows="3" class="form-control" name="comments" placeholder="مقتطف" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="مقتطف"></textarea>
...
<!--                            <option value="1" />شئون فلسطينية-->
<!--                            <option value="2" />رياضة-->
                              <?php
                              foreach ($SubDept as $subdept)
                              {?>
                                      <option value="<?php  echo $subdept->id ?>"><?php  echo $subdept->cat_name ?></option>
                                  <?php
                              }
                              ?>
                          </select>
...
<!--                                <div class="controls">-->
<!--                                    <div class="skin skin-square">-->
<!--                                        <input type="checkbox" name="pinhome" value="1" id="input-15"  />-->
<!--                                        <label for="input-15">تثبيت الخبر</label>-->
<!--                                    </div>-->
<!--                                </div>-->
<!--                            </div>-->
                          <div class="col-md-2 col-sm-2 ">
                          <div class="controls">
                            ...
                            <div class="col-md-2 col-sm-2 ">
                                <div class="controls">
                                    <div class="skin skin-square">
                                        <input type="checkbox" value="1" name="disable_copy" id="input-166"  />
                          ...
                          <div class="row" id="upload-img">
                              ...
                              <div class="col-md-3">
                                  <div class="form-group">
                                      <div class="controls">
                                          <input type="file" onchange="openFile(event)" accept="image/x-png,image/gif,image/jpeg" name="userfile" id="filesToUpload"   class="form-control"  placeholder="" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title=""/>
                                      </div></div>
                              </div>
...
<!--                          </script>-->
                          ...
                          <div class="row" id="seminar-date" style="display: none">
                              <label class="col-md-2 text-xs-right"> تاريخ عقد الندوة:</label>
                              <div class="col-md-4">
                                  <div class="form-group">
                                      <div class="controls">
                                          <input type="datetime-local" name="bdaytime" id="seminars" class="form-control"  placeholder="تاريخ عقد الندوة" data-toggle="tooltip" data-trigger="hover"  data-title="تاريخ عقد الندوة" />
                                      </div></div>
                              </div>
                          </div>
                          <script>
                          ...
                          <div class="row" id="">
                              ...
                              <div class="col-md-7">
                                  <div class=" form-group ">
                                      <div class="controls">
                                          <select  name="author[]" required="" class="select2-tags form-control" dir="rtl" multiple="" id="select2-tags">
                                              <?php
                                  ...
                                  <div class=" form-group ">
                                      <div class="controls">
                                          <select  name="source_name"  class=" select2 select2-rtl  form-control" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="المصدر">
                                              ...
                                              {?>
                                                  <option value="<?php  echo $followsites->id ?>"><?php  echo $followsites->title ?></option>
                                                  <?php
                                              }
                                              ?>
                                          </select>
                                  ...
                                  <div class=" form-group ">
                                      <div class="controls">
                                          <select  name="book_name"  class=" select2 select2-rtl  form-control" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="الكتب">
                                              ...
                                              {?>
                                                  <option value="<?php  echo $books->id ?>"><?php  echo $books->title ?></option>
                                                  <?php
                                              }
                                              ?>
                                          </select>
                        ...
                        <div class="tab-pane fade" id="tabOnlyIcon12" aria-labelledby="baseOnlyIcon-tab12" aria-expanded="false">
                          <br>
                            ...
                            <div class="row">
                                <label class="col-md-2 text-xs-right" >اضافة صور للخبر:</label>
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <div class="controls">
