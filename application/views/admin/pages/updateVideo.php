                        ...
                        <div class="card">
                            ...
                            <div class="card-body collapse in">
                                <div class="card-block">
                                    <form class="form" novalidate="" action="<?php echo base_url().'admin/saveUpdateVideo/'.$videos->id?>" method="post" />
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <input type="url" class="form-control" id="ytlink" onkeyup="youtube_parser(this.value)" name="url" placeholder=" أدخل رابط الفيديو من اليوتيوب"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div id="ytimage">
                                                    <img src="<?php echo base_url();?>/<?php  echo $videos->imghome ?>" alt="">
                                                </div>
                                            </div>
                                        </div>
