        ...
        <div class="content-header row">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">إضافة قسم وسائط
              </li>
            </ol>
          </div>
		...
		<div class="col-xs-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title"><i class="icon-tag"></i> إضافة قسم وسائط</h4>
				...
				<div class="card-body collapse in">
					<form class="form card-block card-dashboard" novalidate="" action="<?php echo base_url().'admin/saveMediaDept'?>" method="post">

                      <div class="row">
                        <div class="form-group col-xs-6 mb-2">
                          <input type="text" id="eventRegInput1" class="form-control" placeholder="اسم القسم" required="" data-validation-required-message="أدخـل القسم" name="medianame" />
                        </div>
                  ...
                  <div class="modal fade text-xs-left" id="update" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                          <div class="modal-content">
                              ...
                              <form action="<?php echo base_url().'admin/updateMediaDept'?>" method="Post" id="form-update" >
...
<script>
    ...
    $(document).on('click','#save',function () {
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('admin/updateMediaDept/');?>",
    ...
    $(document).on('click','#delete1',function () {
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('admin/deleteMediaDept/');?>",
            data: {
                'deptID':$('#deptid2').val()},
            cache:false,
            success:
