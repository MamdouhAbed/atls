    ...
    <div class="content-header row">
      <div class="breadcrumb-wrapper col-xs-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">قائمة الفيديو
          </li>
        </ol>
      </div>
          ...
          <div class="col-xs-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"><i class="icon-tag"></i> قائمة الفيديو</h4>
...
<!--                    <th>رابط الفيديو</th>-->
                    ...
                    {?>
                      <tr>
                        ...
                        <td><a target="_blank" href="<?php  echo $videos->link_youtube ?>"><?php  echo $videos->title ?></a></td>
<!--                        <td>--><?php // echo $videos->link_youtube ?><!--</td>-->
                        <td><?php echo ArabicDate($videos->created_at); ?></td>

                        <td>
                          <a  href="<?php echo base_url().'admin/updateVideo/'.$videos->id?>"><i class="fa fa-pencil info" title="Edit" style="font-size: 20px;"></i></a>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel1"> حذف فيديو </h4>
          </div>
          <form  id="form-delete" >
            <div class="modal-body">
              <div class="row">
                ...
                <div class="form-group" >
                  <h5 class="col-md-8  control-label" >هل تريد حذف الفيديو؟! </h5>
                </div>
              </div>
            </div>
          </form>
...
<script>
  ...
  $(document).on('click','#delete1',function () {
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('admin/deleteVideo/');?>",
      data: {
