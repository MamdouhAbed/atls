        ...
        <div class="content-header row">
            <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">إدارة الكاريكاتير
                    </li>
                </ol>
            </div>
        ...
        <div class="content-body">
            ...
            <section id="image-grid" class="card">
                <div class="card-header">
                    <h4 class="card-title"><i class="icon-tag"></i> إدارة الكاريكاتير</h4>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card border-grey border-lighten-2">
                                            <div class="card-img-top embed-responsive embed-responsive-item embed-responsive-16by9">
                                                <img class="gallery-thumbnail" src="<?php echo base_url(thumb($cari->link,286,191)); ?>" />
                                            </div>
                                            <div class="card-block text-xs-center">
                                                <h4 class="card-title"><?php  echo $cari->name ?></h4>


                                            </div>
                                            <div class="text-xs-center">
                                                <a href="<?php echo base_url().'admin/updateCaricature/'.$cari->id?>" class="btn btn-social-icon mr-1 mb-1 btn-outline-info"><span class="icon-edit"></span></a>
                                                <a id="<?php echo $cari->id?>" class=" btndelete btn btn-social-icon mr-1 mb-1 btn-outline-danger"><span class="icon-trash"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel1"> حذف كاريكاتير </h4>
                    </div>
                    <form  id="form-delete" >
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group" >
                                    <h5 class="col-md-8  control-label" >هل تريد حذف كاريكاتير؟! </h5>
                                </div>
                            </div>
                        </div>
                    </form>
...
<script>
    ...
    $(document).on('click','#delete1',function () {
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('admin/deleteCaricature');?>",
            data: {
                'deptID':$('#deptid2').val()},
            cache:false,
            success:
