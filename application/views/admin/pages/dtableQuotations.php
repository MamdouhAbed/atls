        ...
        <div class="content-header row">
            <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">قائمة الاقتباسات
                    </li>
                </ol>
            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><i class="icon-tag"></i> قائمة الاقتباسات</h4>
                            ...
                            <div class="card-body collapse in">
                                <div class="card-block card-dashboard">
                                    <div class="buttons-group ">
                                        <a href="addQuotations" class="btn btn-info float-md-right"><i class="icon-plus4"></i> إضافة اقتباس</a>
                                    </div>
                                    ...
                                    <table class="table table-striped table-bordered dataex-fixh-responsive">
                                        ...
                                        {?>
                                            <tr>
                                                <td><?php  echo $quotations->id ?></td>
                                                <td><?php  echo $quotations->txt ?></td>
                                                <td><?php  echo $quotations->name ?></td>
                                                <td><?php echo ArabicDate($quotations->created_at); ?></td>

                                                <td>
                                                    <a  href="<?php echo base_url().'admin/updateQuotations/'.$quotations->id?>"><i class="fa fa-pencil info" title="Edit" style="font-size: 20px;"></i></a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel1"> حذف اقتباس </h4>
                    </div>
                    <form  id="form-delete" >
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group" >
                                    <h5 class="col-md-8  control-label" >هل تريد حذف هذا الاقتباس؟! </h5>
                                </div>
                            </div>
                        </div>
                    </form>
...
<script>
    ...
    $(document).on('click','#delete1',function () {
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('admin/deleteQuotations/');?>",
            data: {
                'deptID':$('#deptid2').val()},
            cache:false,
            success:
