				...
				<div class="card-body collapse in">
					<div class="card-block card-dashboard">
                        <div class="buttons-group ">
                            <a href="addNews" class="btn btn-info float-md-right"><i class="icon-plus4"></i> إضافة خبر</a>
                        </div>
						...
						<table class="table table-striped table-bordered" id="news_data">
							<thead>
							     ...
							     <th width="1%">رقم</th>
									...
									<th width="3%">القسم</th>
                                    <th width="1%">الزوار</th>
									<th width="5%">المستخدم</th>
                                 <?php if($this->session->userdata('role')==1){?>
                                     <th width="5%">تعديل بواسطة</th>
                                 <?php } ?>

									<th width="22%">تاريخ الإضافة</th>
									<th width="11%"> مشاركة</th>
									<th width="8%">العمليات</th>
