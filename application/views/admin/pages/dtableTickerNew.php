        ...
        <div class="content-header row">
            <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"> قائمة أخبار الشريط
                    </li>
                </ol>
            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><i class="icon-tag"></i> قائمة أخبار الشريط</h4>
                            ...
                            <div class="card-body collapse in">
                                <div class="card-block card-dashboard">
                                    <div class="buttons-group ">
                                        <a href="addTickerNew" class="btn btn-info float-md-right"><i class="icon-plus4"></i> إضافة خبر على الشريط</a>
                                    </div>
                                    ...
                                    <table class="table table-striped table-bordered ">
                                        ...
                                        <tbody>
                                        <?php
                                        foreach ($tickerNews as $tickernews)
                                        {?>
                                            <tr>
                                                <td><?php  echo $tickernews->id ?></td>
                                                <td><?php  echo $tickernews->title_ticker ?></td>
                                                <td><?php  echo $tickernews->name ?></td>
                                                <td><?php echo ArabicDate($tickernews->created_at); ?></td>
                                                <td>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel1">تعديل عنوان الخبر </h4>
                    </div>
                    <form action="<?php echo base_url().'admin/updateTickerNew'?>" method="Post" id="form-update" >
                        <div class="modal-body">
                            <div class="row">
                                <label class="col-md-2 text-xs-right control-label">عنوان الخبر : </label>
                                <div class="col-sm-9">
...
<script>
    ...
    $(document).on('click','#save',function () {
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('admin/updateTickerNew/');?>",
    ...
    $(document).on('click','#delete1',function () {
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('admin/deleteTickerNew/');?>",
            data: {
                'deptID':$('#deptid2').val()},
            cache:false,
            success:
