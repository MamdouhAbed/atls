    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item"><a href="<?php echo base_url();?>admin/index" class="navbar-brand nav-link"><img alt="logo" src="<?php echo base_url()?>assets/logo/logo_panel.png" data-expand="<?php echo base_url()?>assets/logo/logo_panel.png" data-collapse="<?php echo base_url()?>assets/logo/logo_panel2.png"  height="22px" class="brand-logo" style="margin-top: 10px" /></a></li>
        ...
        <div class="navbar-container content container-fluid">
            <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item nav-search"><a href="<?php echo base_url();?>" class="nav-link nav-link-search fullscreen-search-btn"><i class="ficon icon-home3"></i></a></li>
                    <li class="nav-item hidden-sm-down"><a href="#" class="nav-link nav-link-expand"><i class="ficon icon-expand2"></i></a></li>
                </ul>
                <ul class="nav navbar-nav float-xs-right">
                    <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="<?php echo base_url()?><?php echo $this->session->userdata('img_user')?>" alt="user" /><i></i></span><span class="user-name"><?php echo $this->session->userdata('username')?></span></a>
                        <div class="dropdown-menu dropdown-menu-right"><a href="<?php echo base_url();?>admin/updateUser/<?php echo $this->session->userdata('user_id')?>" class="dropdown-item"><i class="icon-head"></i> تعديل بياناتي</a>
