...
class News_Model extends CI_Model  {
    ...
    public function addAuthors($data)
    {
        ...
        $this->db->insert('author_news',$data);
        return $this->db->insert_id();
    }
...
//
 ...
 public function get_news_tags($id)
    ...
    public function get_news_authors($id)
    {
    ...
    public function addTickerNew($data)
    {

        $this->db->insert('news_ticker',$data);
    }

    public function get_tickernews()
    {
        $this->db->select('news_ticker.*, users.name');
        $this->db->order_by("id" , "desc");
        $this->db->from('news_ticker');
        $this->db->join('users', 'users.id = news_ticker.user_id' , 'left');
        $query = $this->db->get();
        return $query->result();
    }


    public function delTickerNew($id){
    ...
    public function updtTickerNew($id = NULL,$data) {

        $this->db->set('title_ticker', $data);
        $this->db->where('id', $id);
        $this->db->update( 'news_ticker');
